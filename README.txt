...
3.) Open the htdocs folder in the xampp folder. Copy paste the folder lifestylestore.
4.) Open the browser (chrome), type localhost/lifestylestore and you should see the index page of the website.
